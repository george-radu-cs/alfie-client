...
@$core.Deprecated('Use addMarketDeckRequestDescriptor instead')
const AddMarketDeckRequest$json = const {
  '1': 'AddMarketDeckRequest',
};

/// Descriptor for `AddMarketDeckRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMarketDeckRequestDescriptor = $convert.base64Decode('ChRBZGRNYXJrZXREZWNrUmVxdWVzdA==');
@$core.Deprecated('Use updateMarketDeckRequestDescriptor instead')
const UpdateMarketDeckRequest$json = const {
  '1': 'UpdateMarketDeckRequest',
};

/// Descriptor for `UpdateMarketDeckRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMarketDeckRequestDescriptor = $convert.base64Decode('ChdVcGRhdGVNYXJrZXREZWNrUmVxdWVzdA==');
@$core.Deprecated('Use deleteMarketDeckRequestDescriptor instead')
const DeleteMarketDeckRequest$json = const {
  '1': 'DeleteMarketDeckRequest',
};

/// Descriptor for `DeleteMarketDeckRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteMarketDeckRequestDescriptor = $convert.base64Decode('ChdEZWxldGVNYXJrZXREZWNrUmVxdWVzdA==');
@$core.Deprecated('Use getMarketDecksRequestDescriptor instead')
const GetMarketDecksRequest$json = const {
  '1': 'GetMarketDecksRequest',
};

/// Descriptor for `GetMarketDecksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMarketDecksRequestDescriptor = $convert.base64Decode('ChVHZXRNYXJrZXREZWNrc1JlcXVlc3Q=');
@$core.Deprecated('Use getPopularMarketDecksRequestDescriptor instead')
const GetPopularMarketDecksRequest$json = const {
  '1': 'GetPopularMarketDecksRequest',
};

/// Descriptor for `GetPopularMarketDecksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPopularMarketDecksRequestDescriptor = $convert.base64Decode('ChxHZXRQb3B1bGFyTWFya2V0RGVja3NSZXF1ZXN0');
@$core.Deprecated('Use getMarketDeckRequestDescriptor instead')
const GetMarketDeckRequest$json = const {
  '1': 'GetMarketDeckRequest',
};

/// Descriptor for `GetMarketDeckRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMarketDeckRequestDescriptor = $convert.base64Decode('ChRHZXRNYXJrZXREZWNrUmVxdWVzdA==');
@$core.Deprecated('Use getMyMarketDecksRequestDescriptor instead')
const GetMyMarketDecksRequest$json = const {
  '1': 'GetMyMarketDecksRequest',
};

/// Descriptor for `GetMyMarketDecksRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMyMarketDecksRequestDescriptor = $convert.base64Decode('ChdHZXRNeU1hcmtldERlY2tzUmVxdWVzdA==');
@$core.Deprecated('Use addMarketDeckReviewRequestDescriptor instead')
const AddMarketDeckReviewRequest$json = const {
  '1': 'AddMarketDeckReviewRequest',
};

/// Descriptor for `AddMarketDeckReviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMarketDeckReviewRequestDescriptor = $convert.base64Decode('ChpBZGRNYXJrZXREZWNrUmV2aWV3UmVxdWVzdA==');
@$core.Deprecated('Use updateMarketDeckReviewRequestDescriptor instead')
const UpdateMarketDeckReviewRequest$json = const {
  '1': 'UpdateMarketDeckReviewRequest',
};

/// Descriptor for `UpdateMarketDeckReviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMarketDeckReviewRequestDescriptor = $convert.base64Decode('Ch1VcGRhdGVNYXJrZXREZWNrUmV2aWV3UmVxdWVzdA==');
@$core.Deprecated('Use deleteMarketDeckReviewRequestDescriptor instead')
const DeleteMarketDeckReviewRequest$json = const {
  '1': 'DeleteMarketDeckReviewRequest',
};

/// Descriptor for `DeleteMarketDeckReviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteMarketDeckReviewRequestDescriptor = $convert.base64Decode('Ch1EZWxldGVNYXJrZXREZWNrUmV2aWV3UmVxdWVzdA==');
...
@$core.Deprecated('Use addMarketDeckReplyDescriptor instead')
const AddMarketDeckReply$json = const {
  '1': 'AddMarketDeckReply',
};

/// Descriptor for `AddMarketDeckReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMarketDeckReplyDescriptor = $convert.base64Decode('ChJBZGRNYXJrZXREZWNrUmVwbHk=');
@$core.Deprecated('Use updateMarketDeckReplyDescriptor instead')
const UpdateMarketDeckReply$json = const {
  '1': 'UpdateMarketDeckReply',
};

/// Descriptor for `UpdateMarketDeckReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMarketDeckReplyDescriptor = $convert.base64Decode('ChVVcGRhdGVNYXJrZXREZWNrUmVwbHk=');
@$core.Deprecated('Use deleteMarketDeckReplyDescriptor instead')
const DeleteMarketDeckReply$json = const {
  '1': 'DeleteMarketDeckReply',
};

/// Descriptor for `DeleteMarketDeckReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteMarketDeckReplyDescriptor = $convert.base64Decode('ChVEZWxldGVNYXJrZXREZWNrUmVwbHk=');
@$core.Deprecated('Use getMarketDecksReplyDescriptor instead')
const GetMarketDecksReply$json = const {
  '1': 'GetMarketDecksReply',
};

/// Descriptor for `GetMarketDecksReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMarketDecksReplyDescriptor = $convert.base64Decode('ChNHZXRNYXJrZXREZWNrc1JlcGx5');
@$core.Deprecated('Use getPopularMarketDecksReplyDescriptor instead')
const GetPopularMarketDecksReply$json = const {
  '1': 'GetPopularMarketDecksReply',
};

/// Descriptor for `GetPopularMarketDecksReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPopularMarketDecksReplyDescriptor = $convert.base64Decode('ChpHZXRQb3B1bGFyTWFya2V0RGVja3NSZXBseQ==');
@$core.Deprecated('Use getMarketDeckReplyDescriptor instead')
const GetMarketDeckReply$json = const {
  '1': 'GetMarketDeckReply',
};

/// Descriptor for `GetMarketDeckReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMarketDeckReplyDescriptor = $convert.base64Decode('ChJHZXRNYXJrZXREZWNrUmVwbHk=');
@$core.Deprecated('Use getMyMarketDecksReplyDescriptor instead')
const GetMyMarketDecksReply$json = const {
  '1': 'GetMyMarketDecksReply',
};

/// Descriptor for `GetMyMarketDecksReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMyMarketDecksReplyDescriptor = $convert.base64Decode('ChVHZXRNeU1hcmtldERlY2tzUmVwbHk=');
@$core.Deprecated('Use addMarketDeckReviewReplyDescriptor instead')
const AddMarketDeckReviewReply$json = const {
  '1': 'AddMarketDeckReviewReply',
};

/// Descriptor for `AddMarketDeckReviewReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMarketDeckReviewReplyDescriptor = $convert.base64Decode('ChhBZGRNYXJrZXREZWNrUmV2aWV3UmVwbHk=');
@$core.Deprecated('Use updateMarketDeckReviewReplyDescriptor instead')
const UpdateMarketDeckReviewReply$json = const {
  '1': 'UpdateMarketDeckReviewReply',
};

/// Descriptor for `UpdateMarketDeckReviewReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMarketDeckReviewReplyDescriptor = $convert.base64Decode('ChtVcGRhdGVNYXJrZXREZWNrUmV2aWV3UmVwbHk=');
@$core.Deprecated('Use deleteMarketDeckReviewReplyDescriptor instead')
const DeleteMarketDeckReviewReply$json = const {
  '1': 'DeleteMarketDeckReviewReply',
};

/// Descriptor for `DeleteMarketDeckReviewReply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteMarketDeckReviewReplyDescriptor = $convert.base64Decode('ChtEZWxldGVNYXJrZXREZWNrUmV2aWV3UmVwbHk=');
